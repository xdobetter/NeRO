...
def compose_sim_pose(scale, quat, offset, in_pose, object_center):
    ...
    # pose_que = pose_sim_to_pose_rigid(pose_sim_in_to_que, in_pose, que_K, in_K, object_center)  # obj to que
...
# def load_K_Rt_from_P(filename, P=None): # 从P中解出内参和外参
#     if P is None:
